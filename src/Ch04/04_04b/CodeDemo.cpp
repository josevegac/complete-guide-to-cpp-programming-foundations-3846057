...
int main(){
    ...
    start = new TimePoint(Clock::now()); //we are using scope resolution operator (::) isnted of dot (.) because this is a static amember function. So no object of the system_clock class is required.
